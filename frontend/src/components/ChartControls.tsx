...
export const ChartControls: React.FC<ChartControlsProps> = ({
    ...
    return (
        <div className="px-6 py-4 border-b border-neutral-800 flex flex-wrap items-center justify-between gap-4">
            {/* Timeframe Controls */}
...
>
    ...
    className="appearance-none border border-neutral-800 text-neutral-200 text-xs font-bold rounded-xl pl-3 pr-8 py-2 focus:outline-none focus:ring-1 focus:ring-orange-500/50 hover:bg-neutral-900 transition-all cursor-pointer bg-transparent"
    >
