            ...
            {selectedServer ? (
                <div className="h-full">
                    {isMobile && onBackToMaster && (
                        <div className="bg-slate-700/40 backdrop-blur-md border-b border-slate-600/50 p-4 flex items-center">
                            <button
                                onClick={onBackToMaster}
                                className="bg-slate-700/50 hover:bg-slate-600/50 text-gray-300 p-2 rounded-lg transition-colors border border-slate-600/50 mr-4"
                            >
