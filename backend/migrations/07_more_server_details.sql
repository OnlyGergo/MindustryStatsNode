...
create function get_server_details(server_id_param integer)
    returns TABLE(
                     ...
                     detail_ping integer,
                     detail_display_name character varying,
                     detail_description text,
                     detail_mode_name character varying,
                     detail_map_name character varying,
        ...
        -- All columns from server_motds
                     ...
                     detail_motd_server_name varchar(255),
                     detail_motd_description text,
                     detail_motd_mode_name varchar(100),
        -- All columns from server_maps
                     ...
                     detail_map_map_name varchar(255),
